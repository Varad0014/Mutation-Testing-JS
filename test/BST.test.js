...
describe('BST Tests', () => {
    ...
    describe('.insert(key)', () => {
        it('insert element', () => {
            const bst = new BinarySearchTree();
            bst.insert(10);
            expect(bst.getRoot().getKey()).to.equal(10);
        });
    });
    ...
    describe('.findMax()', () => {
        it('find the maximum element', () => {
            ...
            bst.insert(15);
            bst.insert(3);
            expect(bst.findMax()).to.equal(15);
        });
    });
    describe('.findCeil()', () => {
        it('find the ceil element', () => {
            const bst = new BinarySearchTree();
            bst.insert(10);
            bst.insert(5);
            bst.insert(15);
            bst.insert(3);
            expect(bst.findCeil(9)).to.equal(10);
        });
    });
    describe('.findFloor()', () => {
        it('find the floor element', () => {
            const bst = new BinarySearchTree();
            bst.insert(10);
            bst.insert(5);
            bst.insert(15);
            bst.insert(3);
            expect(bst.findFloor(9)).to.equal(5);
        });
    });
